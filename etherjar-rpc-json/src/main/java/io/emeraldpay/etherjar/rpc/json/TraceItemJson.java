...
public class TraceItemJson implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (subtraces != null ? !subtraces.equals(that.subtraces) : that.subtraces != null)
            return false;
        if (traceAddress != null ? !traceAddress.equals(that.traceAddress) : that.traceAddress != null)
            return false;
    ...
    public static class Action implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (address != null ? !address.equals(action.address) : action.address != null)
                return false;
            if (balance != null ? !balance.equals(action.balance) : action.balance != null)
                return false;
    ...
    public static class Result implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (gasUsed != null ? !gasUsed.equals(result.gasUsed) : result.gasUsed != null)
                return false;
            if (output != null ? !output.equals(result.output) : result.output != null)
                return false;
            if (address != null ? !address.equals(result.address) : result.address != null)
                return false;
